...
const formElementPhoto = document.querySelector(".form__type-photo");
const formElementName = document.querySelector(".form__type-name");
const formElementAvatar = document.querySelector(".form__type-avatar");
