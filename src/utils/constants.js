...
const formElementPhoto = document.querySelector(".form__photo");
const formElementName = document.querySelector(".form__name");
const formElementAvatar = document.querySelector(".form__avatar");
